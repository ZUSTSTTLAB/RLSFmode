...
def read_data_from_surface(ply_fn, params):
    ...
    # input_feat, rho, theta, mask, neigh_indices,
    ...
    #
    # dists features
    dists = mesh.get_attribute("vertex_dists")

    # theta features
    vertex_theta = mesh.get_attribute("vertex_theta")
    ...
    for vix in range(n):
        ...
        input_feat[vix, :len(neigh_vix), 2] = vertex_theta[neigh_vix]
        input_feat[vix, :len(neigh_vix), 3] = dists[neigh_vix]
        input_feat[vix, :len(neigh_vix), 4] = charge[neigh_vix]
